...
<head>
    ...
    <title>Ajuan Videotron Saya</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="css/user/tabel.css">
</head>

<body>
    <?php include "ajuan-videotron-saya-tabel.php"; ?>
    ...
    <br>
        <div id="content">
            <div style="text-align: center">
                <h2 style="color:#57ae6c" class="h3 mb-2">AJUAN VIDEOTRON SAYA</h2>
            </div>
        </div>
            ...
            <table id="lookup" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Deskripsi Video</th>
                ...
                <tbody>
                    <?php while ($data = mysqli_fetch_array($hasil)) { $no++; ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                $dokumen_iklan = $data['dokumen_iklan'];
                                $dokumen_iklan_base64 = base64_encode($dokumen_iklan);
                                ?>
                                <form action="view-video-videotron.php" method="post" target="_blank">
                                    <input type="hidden" name="video_data" value="<?php echo $dokumen_iklan_base64; ?>">
                                    <button style="border: none; background-color: rgba(255, 255, 255, 0); color: blue;" type="submit"><i class="fas fa-video text-danger"></i> Lihat Video</button>
                                </form>
                            </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php if ($data["status_permohonan"] == "ditolak") { ?>
                            ...
                            <p style="color: black;">Catatan: <br> Videotron yang diajukan belum memenuhi kriteria iklan layanan masyarakat.</p>
                        <?php } else { ?>
                            <a style="color: black;">Status Permohonan:</a> <br>
    ...
    <?php while ($data = mysqli_fetch_array($hasil)) { ?>
        <div class="modal fade" id="modalDetail_<?php echo $data['id_ajuan']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalDetailLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalDetailLabel">Detail Status Videotron</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
